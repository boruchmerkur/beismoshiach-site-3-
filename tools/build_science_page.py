...
<section class="hero"><div class="wrap">
  ...
  <h1>Convergence</h1>
  <p class="stand">Thirty-three pieces from the magazine's own Moshiach&nbsp;&amp;&nbsp;Science department, set in one grid with a live wire of scientific discovery. Both are sorted against the same six readings from the sources. A resemblance is not a proof, and nothing here is offered as one.</p>
</div></section>
